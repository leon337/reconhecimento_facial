# LEA-125 — Análise crítica da pesquisa de mercado

Este diretório preserva os entregáveis da LEA-125 em formato versionável no GitHub.
...
1. `01_RESUMO_EXECUTIVO.md`
2. `02_AUDITORIA_RELATORIO.md`
3. `03_CATALOGO_FUNCIONAL_01_28.md`
4. `04_CATALOGO_FUNCIONAL_29_56.md`
5. `05_CATALOGO_FUNCIONAL_57_84.md`
6. `06_PRIORIZACAO_01_42.md`
7. `07_PRIORIZACAO_43_84.md`
8. `08_ESCOPO_PRODUTO_PARTE_1.md`
9. `09_ESCOPO_PRODUTO_PARTE_2.md`
10. `10_ESTRATEGIA_TESTES.md`
