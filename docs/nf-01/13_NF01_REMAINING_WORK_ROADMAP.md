...
[ ] I4 — primeiro consumidor incremental do substrato compartilhado
[ ] I5–I9 — adoção/reconciliação e validação incremental do AppShell
```
...
Ler decisões canônicas, este roadmap, closeout da Fase H, checkpoints `47_*`/`48_*`/`49_*`, catálogo, especificação Novo Funcionário V2 e PR #32/HEAD atual; depois continuar pelo primeiro item não concluído.
